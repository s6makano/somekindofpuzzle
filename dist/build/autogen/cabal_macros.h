...
/* package wx-0.92.2.0 */
#define VERSION_wx "0.92.2.0"
#define MIN_VERSION_wx(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  92 || \
  (major1) == 0 && (major2) == 92 && (minor) <= 2)

/* package wxcore-0.92.2.0 */
#define VERSION_wxcore "0.92.2.0"
...
#define CURRENT_PACKAGE_KEY "somek_3QqwRoS4k9oHkRYGMos7xm"
